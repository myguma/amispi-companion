...
| Voice / Whisper | pending | v1.0.3でvoice後click抑制、speech priority、blank/noise rejection、観測質問fallbackを修正。会話品質はfield QA pending |
...
| v1.0.3 hotfix | pending | voice返答上書き防止、`[BLANK_AUDIO]` rejection、観測質問応答、末尾「ん」抑制はfield QA pending |
