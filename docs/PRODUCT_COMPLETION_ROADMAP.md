...
**v0.1.49 / First-run Onboarding 実機QA通過 / 全体進捗: 約 83%**
...
Release Polish: 設定画面更新導線・DebugMode・First-run Onboardingまで実装し、実機QA通過
残り: Memory retention、Emotion sprite set、RuleProvider daily summary活用強化、Whisper実接続、Optional TTSなど
```
