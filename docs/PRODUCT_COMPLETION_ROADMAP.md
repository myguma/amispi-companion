...
### Milestone B — Voice MVP (現在: v0.3.1 hardening / field QA pending)
...
| Phase 6b-real-2: WhisperCli Rust sidecar 統合 | ✅ v0.3.0 MVP / field QA pending |
| Phase 6c: Voice UX Hardening | ✅ v0.3.1 / field QA pending |
...
**v1.0.0-rc.1 / Release Candidate / 全体進捗: 約 93%**
...
Release Candidate: v1.0.0-rc.1でchecklist / release notes draft / Known Issuesを整理。新機能追加なし
残り: v1.0.0 stable docs最終化、実機Voice QA、Optional TTSなど
```
