...
**v0.1.54 / Memory export・data control polish 実装 / 全体進捗: 約 88%**
...
Release Polish: 設定画面更新導線・DebugMode・First-run Onboarding・Memory Retention Policy・JSON exportまで実装
Presence: DailySummary文脈反応、固定文品質整理、quiet/focus/DND発話抑制を追加 (field QA pending)
残り: Release polish、Emotion sprite set、Whisper実接続、Optional TTSなど
```
