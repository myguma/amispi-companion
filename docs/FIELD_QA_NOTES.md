...
- `npm run qa:field-status`: correctly blocked release readiness while v1.6.0 version files/tag / release docs / Release workflow/artifacts / Automated Checks / Day 1-7 evidence / Product Gates / Privacy Boundary / Known Issues remain pending
