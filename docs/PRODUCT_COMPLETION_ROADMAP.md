...
**v0.1.55 / Release polish 実装 / 全体進捗: 約 89%**
...
Release Polish: 設定画面更新導線・DebugMode・First-run Onboarding・Memory Retention Policy・JSON export・Known Issuesまで実装
Presence: DailySummary文脈反応、固定文品質整理、quiet/focus/DND発話抑制を追加 (field QA pending)
残り: v0.2.0 daily-use beta docs consolidation、Emotion sprite set、Whisper実接続、Optional TTSなど
```
