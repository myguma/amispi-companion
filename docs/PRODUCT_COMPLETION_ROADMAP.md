...
**v0.2.1 / Minimal Emotion Sprite Set / 全体進捗: 約 91%**
...
Presence: DailySummary文脈反応、固定文品質整理、quiet/focus/DND発話抑制、最小Emotion Sprite fallbackを追加 (field QA pending)
残り: Expressiveness QA、Whisper実接続、Optional TTSなど
```
