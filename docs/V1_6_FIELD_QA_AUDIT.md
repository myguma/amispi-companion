...
| `npm run qa:field-status` 成功 | correctly blocks release readiness while v1.6.0 version/tag / release docs / Release workflow/artifacts / Automated Checks / Day 1-7 / gates remain pending | pending |
