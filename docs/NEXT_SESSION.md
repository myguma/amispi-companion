...
✅ npm run qa:field-status → correctly blocked release readiness while v1.6.0 version/tag / Automated Checks / Day 1-7 / gates remain pending
```
...
- v1.6.0 release判断前: `npm run qa:field-status` を実行し、v1.6.0 version/tag / Automated Checks / Day 1-7 / Product Gates / Privacy Boundary / Known Issues のpendingが残っていないことを確認する
