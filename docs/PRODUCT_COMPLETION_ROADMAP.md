...
| Phase 6b-real-2: WhisperCli Rust sidecar 統合 | 📋 v0.2.3で計画固定 / 実装はv0.3.0 |
| Phase 6c: Voice UX Hardening | 📋 v0.3.1以降 |
...
**v0.2.3 / Voice Implementation Plan / 全体進捗: 約 91%**
...
Voice: Whisper Push-to-Talk MVPの範囲・安全境界・QA項目をv0.2.3で固定。実装はv0.3.0予定
残り: Whisper実接続、Voice QA hardening、Optional TTSなど
```
