...
- `npm run qa:field-status`: correctly blocked release readiness while v1.6.0 version/tag / Automated Checks / Day 1-7 / Product Gates / Privacy Boundary / Known Issues remain pending
