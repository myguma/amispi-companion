...
### Milestone A — Contextual Companion MVP (現在: ~50%)
...
### Milestone E — Release Polish (未着手)
**目標:** 配布可能な状態に仕上げる。

| 作業 | 状態 |
|------|------|
| Windows installer 動作確認・更新確認 | 部分完了 |
| 初回起動ウィザード | 未着手 |
...
**v0.1.31 / Milestone A 第1段階完了 / 全体進捗: 約 50%**

```
Phase 0–6b-real-1: 完了 (土台・音声入口)
Milestone A 第1段階: 完了 (ActivityInsight・DailySummary・PromptBuilder改善・TransparencyUI)
残り: RuleProvider強化・autonomous speech精度・Milestone B解凍・C・D・E
```
