...
**v1.0.3 / Stable hotfix / 全体進捗: 約 96%**
...
Voice: Whisper Push-to-Talk MVPをv0.3.0でRust commandへ接続し、v1.0.1でFFmpeg WAV変換、v1.0.2でtranscript debug、v1.0.3でvoice後click抑制・speech priority・blank rejectionを追加。Voice conversationはfield QA pending
...
残り: v1.0.3 Voice field QA、長時間常駐QA、必要ならvoice prompt追加修正
```
