...
| リリース品質 (docs) | 95% | v0.2.2 Expressiveness QA docs更新 |
| Windows installer / CI | 82% | Release workflow継続成功。Node.js 24 opt-inを追加 |
| **総合** | **~91%** | v0.2.2で表情切替を抑制方向にQA調整。automated checks passed / field QA pending |
...
優先候補A: **Voice Implementation Plan** ← **推奨**
- Push-to-Talkのみ
- 常時マイク監視なし
- Whisper実接続前にprivacy/QA/設定範囲を固定
